          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 12 }}>
            ...
            <div>
              <h2 style={{ margin: 0, fontFamily: 'var(--font-primary)', fontSize: 'var(--text-2xl)' }}>
                {mode === 'create' ? 'Novo Registro de Saúde' : 'Editar Registro de Saúde'}
              </h2>
              <p style={{ margin: 0, color: 'var(--text-secondary)', fontSize: 'var(--text-sm)' }}>
                {mode === 'create' ? 'Preencha as informações médicas' : 'Atualize os detalhes do registro'}
              </p>
            </div>
          </div>
          <button
